...
const { ToolGroupManager, VolumeRotateMouseWheelTool } = cornerstoneTools;
...
// ======== Set up page ======== //
setTitleAndDescription(
  'Volume Viewport API, rendering a sphere poly data',
...
async function run() {
  ...
  mipToolGroup.addViewport(viewportId, renderingEngineId);
